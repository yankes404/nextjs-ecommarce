...
export const Footer = () => {
    return (
        <footer className="w-screen p-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 2xl:px-48 flex justify-between items-center gap-3.5 bg-muted text-xs mt-auto flex-wrap">
            <span>
